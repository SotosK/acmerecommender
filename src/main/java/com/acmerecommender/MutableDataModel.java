...
/**
 * An in-memory {@link DataModel}, based on {@link GenericDataModel}, but which
 * allows to set and delete preferences without rebuilding it from scratch. <br>
 *
 * This model is very similar to {@link GenericDataModel}, but stores
 * {@link #userIDs} and {@link #itemIDs} in mutable {@link FastIDSet}s, and
...
public final class MutableDataModel extends AbstractDataModel {
    ...
    /**
     * Creates a new empty {@link DataModel}.
     */
     ...
     * {@link DataModel} retains all this information in memory.
     * </p>
     *
     * @param userData

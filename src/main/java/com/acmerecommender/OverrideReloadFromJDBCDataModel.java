 ...
 */
public final class OverrideReloadFromJDBCDataModel implements DataModel {

  private static final Logger log = LoggerFactory.getLogger(OverrideReloadFromJDBCDataModel.class);

  private DataModel delegateInMemory;
  private final JDBCDataModel delegate;
  private final RefreshHelper refreshHelper;

  public OverrideReloadFromJDBCDataModel(JDBCDataModel delegate) throws TasteException {
